...
--
-- Name: change_price(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.change_price() RETURNS TABLE(product_id integer, category_id integer, unit_price numeric)
    LANGUAGE sql
    AS $$
    SELECT products.product_id, products.category_id, 
    CASE
        WHEN products.category_id % 2 = 0 THEN products.unit_price * 1.5
        ELSE products.unit_price / 1.5
    END AS unit_price
    FROM products;
$$;


ALTER FUNCTION public.change_price() OWNER TO postgres;

--
-- Name: check_title_of_courtesy(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.check_title_of_courtesy() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF NEW.title_of_courtesy NOT IN ('Ms.', 'Mrs.', 'Mr.', 'Dr.') OR (NEW.title_of_courtesy IS NULL) THEN
        RAISE EXCEPTION 'Title of courtesy must be one of the following: Ms., Mrs., Mr., Dr.';
    END IF;
    RETURN NEW;
END
$$;
...
ALTER FUNCTION public.check_title_of_courtesy() OWNER TO postgres;

--
-- Name: check_units_in_stock(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.check_units_in_stock() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF NEW.quantity > (SELECT units_in_stock FROM products WHERE product_id = NEW.product_id) THEN
        RAISE EXCEPTION 'Not enough units in stock';
    ELSE
        UPDATE products
        SET units_on_order = units_on_order + NEW.quantity
...
ALTER FUNCTION public.check_units_in_stock() OWNER TO postgres;

--
-- Name: copy_vip_customers(); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.copy_vip_customers()
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER PROCEDURE public.copy_vip_customers() OWNER TO postgres;

--
-- Name: count_unshipped_orders(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.count_unshipped_orders() RETURNS integer
    LANGUAGE sql
    AS $$
...
ALTER FUNCTION public.count_unshipped_orders() OWNER TO postgres;

--
-- Name: customers_by_country(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.customers_by_country(input_country character varying) RETURNS TABLE(customer_id character varying, company_name character varying)
    LANGUAGE sql
    AS $_$
...
ALTER FUNCTION public.customers_by_country(input_country character varying) OWNER TO postgres;

--
-- Name: increase_salary(real); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.increase_salary(percent real) RETURNS void
    LANGUAGE sql
    AS $$
    UPDATE employees
    SET salary = salary * (1 + (percent * 0.01)::REAL);
$$;


ALTER FUNCTION public.increase_salary(percent real) OWNER TO postgres;

--
-- Name: increase_salary(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.increase_salary(percent integer) RETURNS void
    LANGUAGE sql
    AS $$
    UPDATE employees
...
ALTER FUNCTION public.increase_salary(percent integer) OWNER TO postgres;

--
-- Name: laba9(real, real, real, real); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.laba9(cur real, mini real, maxi real, pr real) RETURNS character varying
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF (mini > maxi) THEN
        RAISE EXCEPTION '❌Минимальная цена товара превышает максимальную!';
    ELSEIF (mini < 0 OR maxi < 0) THEN
        RAISE EXCEPTION '❌Ни минимальная, ни максимальная цена товара не могут быть меньше нуля!';
    ELSEIF (cur < 0) THEN
        RAISE EXCEPTION '❌Текущая цена товара не может быть меньше нуля!';
    ELSEIF (cur*(1+pr) > maxi) THEN
        RAISE EXCEPTION '❌Цена товара после увеличения превышает максимальную!';
    ELSEIF (cur*(1+pr) < mini) THEN
        RAISE EXCEPTION '❌Цена товара после увеличения меньше минимальной!';
    ELSEIF (pr < 0.1 AND pr > -0.1) THEN
        RAISE EXCEPTION '❌Коэффициент изменения цены товара не может быть ниже 0.1!';
    ELSE
        RAISE NOTICE '✅Всё хорошо!';
    END IF;

    RETURN 'Всё! Всё хорошо! 🤪';
END;
$$;


ALTER FUNCTION public.laba9(cur real, mini real, maxi real, pr real) OWNER TO postgres;

--
-- Name: min_max_price(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.min_max_price() RETURNS TABLE(category_id integer, min_price numeric, max_price numeric)
    LANGUAGE sql
    AS $$
...
ALTER FUNCTION public.min_max_price() OWNER TO postgres;

--
-- Name: min_max_salary(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.min_max_salary(input_city character varying) RETURNS TABLE(min_salary numeric, max_salary numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.min_max_salary(input_city character varying) OWNER TO postgres;

--
-- Name: products_audit(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.products_audit() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.products_audit() OWNER TO postgres;

--
-- Name: update_units_on_order(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_units_on_order() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE products
    SET units_on_order = units_on_order - OLD.quantity
...
ALTER FUNCTION public.update_units_on_order() OWNER TO postgres;
...
--
-- Name: products_audit_audit_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.products_audit_audit_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.products_audit_audit_id_seq OWNER TO postgres;

--
-- Name: products_audit_audit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.products_audit_audit_id_seq OWNED BY public.products_audit.audit_id;
...
CREATE VIEW public.view1 AS
 SELECT orders.order_date,
    ...
    employees.title
   FROM ((public.orders
     JOIN public.employees ON ((orders.employee_id = employees.employee_id)))
...
--
-- Name: vip_customers; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.vip_customers OWNER TO postgres;

--
-- Name: Премия за 1997; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public."Премия за 1997" AS
SELECT
    NULL::bigint AS "Кол-во заказов",
    NULL::smallint AS employee_id,
    NULL::character varying(10) AS first_name,
    NULL::character varying(20) AS last_name,
    NULL::text AS "Премия";


ALTER TABLE public."Премия за 1997" OWNER TO postgres;

--
-- Name: products_audit audit_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.products_audit ALTER COLUMN audit_id SET DEFAULT nextval('public.products_audit_audit_id_seq'::regclass);
...
AAAAA	fake_company	Alfred Mann	\N	\N	\N	\N	\N	USA	\N	\N
BBBBB	fake_company	Alfred Mann	\N	\N	\N	\N	\N	Austria	\N	\N
\.
...
COPY public.employees (employee_id, last_name, first_name, title, title_of_courtesy, birth_date, hire_date, address, city, region, postal_code, country, home_phone, extension, photo, notes, reports_to, photo_path, salary) FROM stdin;
1	Davolio	Nancy	Sales Representative	Ms.	1948-12-08	1992-05-01	507 - 20th Ave. E.\\nApt. 2A	Seattle	WA	98122	USA	(206) 555-9857	5467	\\x	Education includes a BA in psychology from Colorado State University in 1970.  She also completed The Art of the Cold Call.  Nancy is a member of Toastmasters International.	2	http://accweb/emmployees/davolio.bmp	1743.5249
...
9	Dodsworth	Anne	Sales Representative	Ms.	1966-01-27	1994-11-15	7 Houndstooth Rd.	London	\N	WG2 7LT	UK	(71) 555-4444	452	\\x	Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.	5	http://accweb/emmployees/davolio.bmp	11127.375
10	Doe	John	Sales Representative	Mr.	1970-01-01	1992-05-01	123 Main St	Springfield	IL	62701	USA	555-1234	123	\\x70686f746f	\N	2	photo_path	\N
\.
...
1	Chai	8	1	10 boxes x 30 bags	69	30	55	10	1
\.
...
COPY public.products_audit (audit_id, product_name, old_price, new_price, change_date) FROM stdin;
1	Chai	69	9	2024-02-20
2	Chai	9	69	2024-02-20
\.
...
--
-- Data for Name: vip_customers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.vip_customers (customer_id, company_name, contact_name, contact_title, address, city, region, postal_code, country, phone, fax) FROM stdin;
QUICK	QUICK-Stop	Horst Kloss	Accounting Manager	Taucherstraße 10	Cunewalde	\N	01307	Germany	0372-035188	\N
SAVEA	Save-a-lot Markets	Jose Pavarotti	Sales Representative	187 Suffolk Ln.	Boise	ID	83720	USA	(208) 555-8097	\N
ERNSH	Ernst Handel	Roland Mendel	Sales Manager	Kirchgasse 6	Graz	\N	8010	Austria	7675-3425	7675-3426
\.
...
--
-- Name: products_audit_audit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.products_audit_audit_id_seq', 2, true);
...
--
-- Name: vip_customers vip_customers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vip_customers
    ADD CONSTRAINT vip_customers_pkey PRIMARY KEY (customer_id);


--
-- Name: Премия за 1997 _RETURN; Type: RULE; Schema: public; Owner: postgres
--

CREATE OR REPLACE VIEW public."Премия за 1997" AS
 SELECT count(employees.employee_id) AS "Кол-во заказов",
    employees.employee_id,
    employees.first_name,
    employees.last_name,
        CASE
            WHEN (count(employees.employee_id) > 60) THEN 'Выдать Премию! 😎'::text
            ELSE 'Плохо работали! 😡'::text
        END AS "Премия"
   FROM (public.orders
     JOIN public.employees ON ((employees.employee_id = orders.employee_id)))
  WHERE (date_part('year'::text, orders.order_date) = (1997)::double precision)
  GROUP BY employees.employee_id
  ORDER BY (count(employees.employee_id)) DESC;


--
-- Name: employees check_title_of_courtesy; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER check_title_of_courtesy BEFORE INSERT OR UPDATE ON public.employees FOR EACH ROW EXECUTE FUNCTION public.check_title_of_courtesy();


--
-- Name: order_details check_units_in_stock; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER check_units_in_stock BEFORE INSERT ON public.order_details FOR EACH ROW EXECUTE FUNCTION public.check_units_in_stock();


--
-- Name: order_details check_units_in_stock_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER check_units_in_stock_trigger BEFORE INSERT ON public.order_details FOR EACH ROW EXECUTE FUNCTION public.check_units_in_stock();
...
CREATE TRIGGER products_audit AFTER UPDATE ON public.products FOR EACH ROW EXECUTE FUNCTION public.products_audit();


--
-- Name: order_details update_units_on_order_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_units_on_order_trigger AFTER DELETE OR UPDATE ON public.order_details FOR EACH ROW EXECUTE FUNCTION public.update_units_on_order();
...
GRANT SELECT,INSERT ON TABLE public.categories TO warehouse;
GRANT SELECT ON TABLE public.categories TO boss;
...
GRANT SELECT ON TABLE public.customer_customer_demo TO boss;
...
GRANT SELECT ON TABLE public.customer_demographics TO boss;
...
GRANT SELECT,INSERT ON TABLE public.customers TO manager;
GRANT SELECT ON TABLE public.customers TO boss;
...
GRANT SELECT ON TABLE public.employee_territories TO boss;
...
GRANT SELECT,INSERT,UPDATE ON TABLE public.employees TO personnel;
GRANT SELECT,DELETE ON TABLE public.employees TO boss;
...
GRANT SELECT,INSERT,UPDATE ON TABLE public.order_details TO manager;
GRANT SELECT ON TABLE public.order_details TO boss;
...
GRANT SELECT ON TABLE public.orders TO boss;
...
GRANT SELECT,INSERT,UPDATE ON TABLE public.products TO warehouse;
GRANT SELECT ON TABLE public.products TO boss;


--
-- Name: TABLE products_audit; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.products_audit TO boss;
...
GRANT SELECT ON TABLE public.region TO boss;
...
GRANT SELECT,INSERT,UPDATE ON TABLE public.shippers TO boss;
...
GRANT SELECT,INSERT,UPDATE ON TABLE public.suppliers TO boss;
...
GRANT SELECT ON TABLE public.territories TO boss;
...
GRANT SELECT ON TABLE public.us_states TO boss;


--
-- Name: TABLE view1; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.view1 TO boss;


--
-- Name: TABLE view2; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.view2 TO boss;


--
-- Name: TABLE view3; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.view3 TO boss;


--
-- Name: TABLE "Премия за 1997"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public."Премия за 1997" TO boss;
